...
Original file is located at
    https://colab.research.google.com/drive/190yMNgWGYDSGgRmwm7wn_JQHZif4VsoQ
"""
...
def fetch_stock_price():
    ...
    api_url = "https://api.twelvedata.com/time_series?apikey=0f7a1eef3974452cbe0417cb28fa9652&interval=1min&type=stock&dp=1&symbol=MSFT&format=JSON"
...
def send_to_event_hub(data):
    ...
    connection_str = "Endpoint=sb://btcstock.servicebus.windows.net/;SharedAccessKeyName=msftmanage;SharedAccessKey=GWK1zhson8IlgTNOrxSoSCOj1EKx1iFAR+AEhHgqqFY=;EntityPath=msft"
    eventhub_name = "msft"
    ...
    with producer:
        ...
        print("MSFT stock data sent to Event Hub")
